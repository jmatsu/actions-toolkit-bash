...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const single_line_txt = core.getInput('single_line_file_path');
            const single_line_wo_newline_txt = core.getInput('single_line_wo_newline_file_path');
            const multiple_lines_txt = core.getInput('multiple_lines_file_path');
            const multiple_lines_wo_newline_txt = core.getInput('multiple_lines_wo_newline_file_path');
